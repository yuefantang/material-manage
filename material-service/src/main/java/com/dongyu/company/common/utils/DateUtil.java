...
public class DateUtil {
     ...
     * @return 格式化后的Date时间
     */
    public static Date parseDateToDate(Date time, String timeFromat) {
        String dateToStr = parseDateToStr(time, timeFromat);
        Date date = parseStrToDate(dateToStr, timeFromat);
        return date;
    }
